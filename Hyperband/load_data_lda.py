...
def main():
    ...
    # split the train_data to train and test data
    data = train_data
    train_data, test_data = train_test_split(data, train_size=0.8, test_size=0.2, shuffle=True, random_state=100)
    ...
    print('\nsave test_data to pickle file ...')
    with open('test_data.pkl', 'wb') as fh:
